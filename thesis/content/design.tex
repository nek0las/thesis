...
Well-formedness conditions are the important properties that give each set and relation a meaning. Only when the relations satisfy these conditions do we say they are well-formed; otherwise they are meaningless. Most of the wellformedness conditions are adapted from the herdtools7 Coq development \cite{10.1145/2627752, 10.1145/3458926ArmedCat}.

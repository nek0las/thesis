...
The wellformess is the important perperties that give each set and relation a semantic, only when the relations follow these semantics, we say they're wellformenss, otherwise they're meaningless. Most of the formeness are adapted from the https://github.com/herd/herdtools7/blob/c78279fa32f0c0d37e90d083d966b726f781014e/herd/libdir/arm-models/proofs/mixed_v8_equivalences.v#L4
...
We summarized all the supported syntax in \ref{} using LKMM as the example. The yellow part is what can be supported now; the other parts are what we can't support.

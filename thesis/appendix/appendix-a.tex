...
and unmatched-po      = [unmatched] ; (*@\supported{po}@*) ; [unmatched]
and unmatched-locks-to-unlocks =
    [unmatched-locks] ; (*@\supported{po}@*) ; [unmatched-unlocks]
and matched = matched |
...
(* SRCU matching *)
let carry-srcu-data = ((*@\supported{data}@*) ; [~ Srcu-unlock] ; (*@\supported{rf}@*))*
let srcu-rscs =
    ([Srcu-lock] ; carry-srcu-data ; (*@\supported{data}@*) ; [Srcu-unlock]) & loc
...
flag ~empty rcu-rscs & ((*@\supported{po}@*) ; [Sync-srcu] ; (*@\supported{po}@*))
    as invalid-sleep
...
let Marked =
    (~M) | IW | ONCE | RELEASE | ACQUIRE | MB | RMW |
    LKR | LKW | UL | LF | RL | RU | Srcu-lock | Srcu-unlock

let Plain = M \ Marked

(* Dependency propagation *)
let carry-dep = ((*@\supported{data}@*) ; [~ Srcu-unlock] ; rfi)*
let (*@\supported{addr}@*) = carry-dep ; addr
let (*@\supported{ctrl}@*) = carry-dep ; ctrl
let (*@\supported{data}@*) = carry-dep ; data
